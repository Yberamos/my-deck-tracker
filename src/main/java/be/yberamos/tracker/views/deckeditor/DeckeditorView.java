package be.yberamos.tracker.views.deckeditor;

import be.yberamos.tracker.data.entity.SampleAddress;
import be.yberamos.tracker.data.service.SampleAddressService;
...
@Route(value = "address-form2", layout = MainLayout.class)
public class DeckeditorView extends Div {
    ...
    public DeckeditorView(SampleAddressService addressService) {
        addClassName("deckeditor-view");
