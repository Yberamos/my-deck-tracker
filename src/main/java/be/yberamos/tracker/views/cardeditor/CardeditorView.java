package be.yberamos.tracker.views.cardeditor;
...
public class CardeditorView extends Div {
    ...
    public CardeditorView(SampleAddressService addressService) {
        addClassName("cardeditor-view");
